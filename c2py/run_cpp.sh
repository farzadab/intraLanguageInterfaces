...
# 0. have your C++ code ready: swig_example.cpp
...
# 3. Build C++ wrapper:
swig3.0 -python -c++ swig_example.i  # outputs `swig_example_wrap.c`
# 4. Compile the code to get the `.so` file
g++ -fPIC -c swig_example.c swig_example_wrap.c -I/usr/include/python3.5/  # outputs `swig_example.o` and `swig_example_wrap.o`
